      ...
      <Dialog as="div" className="relative z-10" onClose={props.setOpen}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative max-w-xl transform overflow-visible whitespace-normal rounded-lg bg-slate-800 text-sm shadow-xl transition-all sm:my-8  sm:p-6">
                ...
                <div className=" p-4 font-code sm:text-left">
                  <div className=" text-sky-300">result: {props.result}</div>
                </div>
              </Dialog.Panel>
            </Transition.Child>
          </div>
